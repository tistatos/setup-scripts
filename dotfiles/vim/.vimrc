...
" Renderman shader language syntax
" Plugin 'vim-scripts/rslTools'
...
au BufRead,BufNewFile *.sl set filetype=sl

"cpp header snippet
autocmd bufnewfile *.cpp,*.c so /home/tistatos/.vim/cppheader.template
autocmd bufnewfile *.h so /home/tistatos/.vim/cppheader.template
autocmd bufnewfile *.cpp,*.c,*.h exe "1," . 6 . "g/file.*/s//file " . expand("%:t")
autocmd bufnewfile *.cpp,*.c,*.h exe "1," . 6 . "g/date.*/s//date " .strftime("%d-%m-%Y")
autocmd bufnewfile *.h exe "8," . 11 . "g/#ifndef.*/s//#ifndef __" . toupper(expand("%:t:r")) . "_H__"
autocmd bufnewfile *.h exe "8," . 11 . "g/#define.*/s//#define __" . toupper(expand("%:t:r")) . "_H__"
